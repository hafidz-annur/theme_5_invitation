...
<template>
  <div
    ...
    :class="hide_menu ? 'bottom-5 w-full justify-center gap-2' : 'bottom-[60px] flex-col right-7'"
  >
    <v-btn
      size="x-small"
      color="primary"
  ...
  <div
    class="fixed left-0 z-[9999] w-full transition-all ease-in-out duration-500"
    :class="hide_menu ? '-bottom-[100dvh]' : 'bottom-0'"
  >
    <v-tabs
      v-model="selected"
      align-tabs="center"
