...
<template>
  <v-container class="relative p-0">
    ...
    <div class="flex items-center h-[100dvh] bg-gray-700/80 p-5 w-full">
      <div class="overflow-hidden animate__animated animate__fadeInUp">
        ...
        <!-- Kehadiran  -->
        <div
          class="h-[55dvh] rounded-lg shadow-lg overflow-auto pb-[150px] animate__animated animate__zoomIn animate__delay-4s"
        >
          <div
